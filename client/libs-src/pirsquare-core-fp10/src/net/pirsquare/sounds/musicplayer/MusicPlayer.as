package net.pirsquare.sounds.musicplayer
{
	
	import flash.events.Event;
	import flash.media.ID3Info;
	
	import net.pirsquare.sounds.component.Group;
	...
	public class MusicPlayer extends Group implements IAudioItem
	{
		 ...
		 */		
		public function MusicPlayer(_items:* = null, _name:String = null) 
		{
			_loop = true;
			super(_items, _name);
		}
