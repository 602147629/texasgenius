package com.sleepydesign.components
{
	...
	public class SDTreeNode extends SDComponent
	{
		...
		protected var _backSP:SDSprite;
		...
		override public function draw():void
		{
			...
			if (childs)
			{
				...
				_backSP.graphics.lineStyle(0.25, 0x000000, 1, true, LineScaleMode.NONE);
				_backSP.graphics.moveTo(0, _size / 2);
				_backSP.graphics.lineTo(_size, _size / 2);
				_backSP.graphics.moveTo(_size / 2, 0);
				_backSP.graphics.lineTo(_size / 2, _size);
