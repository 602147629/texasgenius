package com.sleepydesign.components
{
	...
	import com.sleepydesign.components.styles.StyleSheetUtil;
	...
	public class SDDialog extends SDComponent
	{
		...
		public function SDDialog(iText:* = "", caller:Object = null, align:String = AlignUtil.MIDDLE_CENTER, style:ISDStyle = null)
		{
			super(style);
		...
		{
			_label.styleSheet = StyleSheetUtil.parseCSS(iCSSText);
			draw();
		}
		...
		private function setLabel(iText:*):void
		{
			...
			_label.styleSheet = StyleSheetUtil.parseCSS();
